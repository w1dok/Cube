...
namespace magic_cube
{
    public class Cube2D
    {
        ...
        {
            return isUnscrambledB() && isUnscrambledD() && isUnscrambledF()
                && isUnscrambledL() && isUnscrambledR() && isUnscrambled();
        }
        ...
        private void rotateFace(List<List<int>> substitution, RotationDirection d)
        {
            ...
            foreach (List<int> s in substitution)
            {
