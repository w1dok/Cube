...
namespace cube
{
    ...
    public class Movement
    {
        ...
        {
            get { return this.touchedFaces; }
            set { this.touchedFaces = value;
                swipedFaces.Clear();
                parse();
            }
        }
        ...
        {
            KeyValuePair<Move, RotationDirection> retval = new 
                KeyValuePair<Move, RotationDirection>(Move.None, RotationDirection.None);
        ...
        private SwipeDirection getSingleDirection()
        {
            ...
            foreach (var item in swipedFaces)
            {
                directionCount[item.direction]++;
            }
